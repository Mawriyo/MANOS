...
#include <stddef.h>
#include "custom_msg/msg/detail/pos__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  custom_msg__msg__Pos__init(message_memory);
}

void Pos__rosidl_typesupport_introspection_c__Pos_fini_function(void * message_memory)
{
  custom_msg__msg__Pos__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Pos__rosidl_typesupport_introspection_c__Pos_message_member_array[2] = {
  {
    "x",  // name
    ...
    offsetof(custom_msg__msg__Pos, x),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msg__msg__Pos, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_msg, msg, Pos)() {
