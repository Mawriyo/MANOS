...
#include "custom_msg/srv/detail/set_servo__rosidl_typesupport_fastrtps_c.h"
...
using _SetServo_Request__ros_msg_type = custom_msg__srv__SetServo_Request;
...
size_t get_serialized_size_custom_msg__srv__SetServo_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetServo_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msg__srv__SetServo_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_msg
size_t max_serialized_size_custom_msg__srv__SetServo_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_custom_msg__srv__SetServo_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msg, srv, SetServo_Request)() {
...
using _SetServo_Response__ros_msg_type = custom_msg__srv__SetServo_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_msg
size_t get_serialized_size_custom_msg__srv__SetServo_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetServo_Response__ros_msg_type * ros_message = static_cast<const _SetServo_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msg__srv__SetServo_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_msg
size_t max_serialized_size_custom_msg__srv__SetServo_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_custom_msg__srv__SetServo_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msg, srv, SetServo_Response)() {
...
// already included above
// #include "custom_msg/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "custom_msg/srv/set_servo.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msg, srv, SetServo)() {
