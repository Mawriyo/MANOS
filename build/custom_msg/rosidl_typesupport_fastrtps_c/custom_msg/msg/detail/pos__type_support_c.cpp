...
#include "custom_msg/msg/detail/pos__rosidl_typesupport_fastrtps_c.h"
...
using _Pos__ros_msg_type = custom_msg__msg__Pos;
...
static uint32_t _Pos__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msg__msg__Pos(
...
{
  return max_serialized_size_custom_msg__msg__Pos(
    full_bounded, 0);
}
