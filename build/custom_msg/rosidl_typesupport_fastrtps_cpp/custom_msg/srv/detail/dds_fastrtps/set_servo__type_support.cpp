...
#include "custom_msg/srv/detail/set_servo__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msg::srv::SetServo_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msg::srv::SetServo_Request & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
...
{
  auto typed_message =
    static_cast<const custom_msg::srv::SetServo_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msg::srv::SetServo_Request *>(
    untyped_ros_message);
...
{
  return &custom_msg::srv::typesupport_fastrtps_cpp::_SetServo_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msg, srv, SetServo_Request)() {
  return &custom_msg::srv::typesupport_fastrtps_cpp::_SetServo_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msg
cdr_serialize(
  const custom_msg::srv::SetServo_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msg::srv::SetServo_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const custom_msg::srv::SetServo_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_msg::srv::SetServo_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_msg::srv::typesupport_fastrtps_cpp::_SetServo_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msg, srv, SetServo_Response)() {
  return &custom_msg::srv::typesupport_fastrtps_cpp::_SetServo_Response__handle;
}
...
{
  return &custom_msg::srv::typesupport_fastrtps_cpp::_SetServo__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msg, srv, SetServo)() {
  return &custom_msg::srv::typesupport_fastrtps_cpp::_SetServo__handle;
}
