...
#include "custom_msg/msg/detail/pos__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const custom_msg::msg::Pos *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msg::msg::Pos *>(
    untyped_ros_message);
...
{
  return &custom_msg::msg::typesupport_fastrtps_cpp::_Pos__handle;
}
