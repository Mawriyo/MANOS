...
#include "custom_msg/msg/detail/four_point_rect__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msg::msg::FourPointRect & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msg::msg::FourPointRect & ros_message)
{
  // Member: xmin
  cdr >> ros_message.xmin;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msg
max_serialized_size_FourPointRect(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  auto typed_message =
    static_cast<const custom_msg::msg::FourPointRect *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msg::msg::FourPointRect *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FourPointRect__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const custom_msg::msg::FourPointRect *>(
...
{
  return max_serialized_size_FourPointRect(full_bounded, 0);
}

static message_type_support_callbacks_t _FourPointRect__callbacks = {
  "custom_msg::msg",
  "FourPointRect",
...
static rosidl_message_type_support_t _FourPointRect__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FourPointRect__callbacks,
...
{
  return &custom_msg::msg::typesupport_fastrtps_cpp::_FourPointRect__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msg, msg, FourPointRect)() {
  return &custom_msg::msg::typesupport_fastrtps_cpp::_FourPointRect__handle;
}
