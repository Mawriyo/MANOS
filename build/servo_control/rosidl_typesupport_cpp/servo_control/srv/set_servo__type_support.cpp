...
static const _SetServo_Request_type_support_symbol_names_t _SetServo_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, servo_control, srv, SetServo_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, servo_control, srv, SetServo_Request)),
  }
};
...
{
  return &::servo_control::srv::rosidl_typesupport_cpp::SetServo_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, servo_control, srv, SetServo_Request)() {
  return get_message_type_support_handle<servo_control::srv::SetServo_Request>();
}
...
static const _SetServo_Response_type_support_symbol_names_t _SetServo_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, servo_control, srv, SetServo_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, servo_control, srv, SetServo_Response)),
  }
};
...
{
  return &::servo_control::srv::rosidl_typesupport_cpp::SetServo_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, servo_control, srv, SetServo_Response)() {
  return get_message_type_support_handle<servo_control::srv::SetServo_Response>();
}
...
static const _SetServo_type_support_symbol_names_t _SetServo_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, servo_control, srv, SetServo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, servo_control, srv, SetServo)),
  }
};
...
{
  return &::servo_control::srv::rosidl_typesupport_cpp::SetServo_service_type_support_handle;
}
