...
from custom_msg.msg import Pos, ListString, FourPointRect
...
class Castlet(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.cameraAspect = self.node.create_publisher(FourPointRect,"/MANOS/WorkSpace",self.qos_profile)
        ...
        self.castelet_ui.gridLayout_2.addWidget(self.Cam, 4, 1, 1, 1)   
        self.castelet_ui.camera_lb = self.Cam
        self.CameraTImer = self.node.create_timer(1, self.cameraMsg)
        self.topics = []
...
###################################################################################################
    ...
    def cameraMsg(self):
        self.posOBject = FourPointRect()
        self.posOBject.xmin = self.Cam.xmin
        self.posOBject.ymin = self.Cam.ymin
        self.posOBject.xmax = self.Cam.xmax
        self.posOBject.ymax = self.Cam.ymax
        self.cameraAspect.publish(self.posOBject)
