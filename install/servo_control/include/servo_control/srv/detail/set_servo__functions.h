...
#ifndef SERVO_CONTROL__SRV__DETAIL__SET_SERVO__FUNCTIONS_H_
#define SERVO_CONTROL__SRV__DETAIL__SET_SERVO__FUNCTIONS_H_
 ...
 * calls
 * servo_control__srv__SetServo_Request__init().
...
/**
 * It calls
 * servo_control__srv__SetServo_Request__fini()
 ...
 * servo_control__srv__SetServo_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * servo_control__srv__SetServo_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * servo_control__srv__SetServo_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_servo_control
...
/**
 * It calls
 * servo_control__srv__SetServo_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_servo_control
...
/**
 * It allocates the memory for the array and calls
 * servo_control__srv__SetServo_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_servo_control
...
/**
 * It calls
 * servo_control__srv__SetServo_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SERVO_CONTROL__SRV__DETAIL__SET_SERVO__FUNCTIONS_H_
